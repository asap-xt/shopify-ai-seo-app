...
class AIDiscoveryService {
  ...
  async generateRobotsTxt(shop) {
    try {
      ...
      console.log('[ROBOTS] Plan:', normalizedPlan);
      console.log('[ROBOTS] Available bots for plan:', availableBotsForPlan);
      ...
      console.log('[ROBOTS] Enabled bots (after plan filter):', enabledBots);
      ...
      // Get app proxy subpath from environment or use default
      // This should match the subpath in shopify.app.toml
      const appProxySubpath = process.env.APP_PROXY_SUBPATH || 'new-ai-seo';
      console.log('[ROBOTS] App proxy subpath:', appProxySubpath);
