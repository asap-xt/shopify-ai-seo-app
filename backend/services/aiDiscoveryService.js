...
class AIDiscoveryService {
  ...
  async generateRobotsTxt(shop) {
    try {
      ...
      robotsTxt += '# Generated by indexAIze - AI Discovery & SEO\n\n';
...
`;
  ...
  async generateLlmsTxt(shop) {
    try {
      ...
      llmsTxt += `generator: indexAIze - AI Discovery & SEO\n`;
  ...
  async generateLlmsFullTxt(shop) {
    try {
      ...
      fullTxt += `generator: indexAIze - AI Discovery & SEO\n`;
