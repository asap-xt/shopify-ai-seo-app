import{j as e}from"./app-bridge-B5-rAdx8-1763531350917.js";import{r as d}from"./react-vendor-tAaa2TlE-1763531350917.js";import{m as L}from"./sessionFetch-ChE0M1pJ-1763531350917.js";import"./usePlanHierarchy-BjUEvxZF-1763531350917.js";import{C as p,B as o,a as i,n as z,T as t,d as y,s as N,I as m,f as _,b,t as c,k as P}from"./polaris-BtthT4kO-1763531350917.js";import"./index-7C12H-UM-1763531350917.js";const T=(u,n="")=>{try{return new URLSearchParams(window.location.search).get(u)||n}catch{return n}},l=(...u)=>{};function V({shop:u}){const n=u||T("shop","");l('[SCHEMA-DATA] qs("shop"):',T("shop",""));const[x,k]=d.useState(0),[v,g]=d.useState(!0),[r,C]=d.useState({organization:null,website:null,products:[]}),[A,h]=d.useState(""),j=d.useMemo(()=>L(),[]),[H,E]=d.useState(""),[R,D]=d.useState(null);d.useEffect(()=>{n&&(w(),I())},[n,j]);const I=async()=>{var s,a;try{const f=await j("/graphql",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:`
