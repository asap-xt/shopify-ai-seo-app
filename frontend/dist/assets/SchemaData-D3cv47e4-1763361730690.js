import{j as e}from"./app-bridge-B3ZBNaUq-1763361730690.js";import{r as d}from"./react-vendor-tAaa2TlE-1763361730690.js";import{m as H}from"./sessionFetch-CpdIU_Ze-1763361730690.js";import"./usePlanHierarchy-BjUEvxZF-1763361730690.js";import{C as p,B as i,a as r,n as O,T as n,d as f,s as R,I as m,f as y,b,t as c,k as P}from"./polaris-CxjldItW-1763361730690.js";import"./index-Cwsm_UMz-1763361730690.js";const T=(g,t="")=>{try{return new URLSearchParams(window.location.search).get(g)||t}catch{return t}},l=(...g)=>{};function J({shop:g}){const t=g||T("shop","");l('[SCHEMA-DATA] qs("shop"):',T("shop",""));const[A,_]=d.useState(0),[v,u]=d.useState(!0),[o,k]=d.useState({organization:null,website:null,products:[]}),[w,h]=d.useState(""),j=d.useMemo(()=>H(),[]),[$,I]=d.useState(""),[B,E]=d.useState(null);d.useEffect(()=>{t&&(C(),M())},[t,j]);const M=async()=>{var s,a;try{const S=await j("/graphql",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:`
