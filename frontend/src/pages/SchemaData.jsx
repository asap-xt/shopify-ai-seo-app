...
{`{%- comment -%} Advanced Schema Data - Auto-generated by indexAIze - AI Discovery & SEO {%- endcomment -%}
...
{%- endif -%}`}
                          ...
                          <InlineStack align="end">
                            <Button 
                              onClick={() => {
                                const code = `{%- comment -%} Advanced Schema Data - Auto-generated by indexAIze - AI Discovery & SEO {%- endcomment -%}
