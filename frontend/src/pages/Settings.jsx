...
export default function Settings() {
  ...
  try {
    ...
    <BlockStack gap="600">
      ...
      {/* Danger Zone - Uninstall Preparation */}
      <Card>
        <Box padding="400">
          <BlockStack gap="400">
            <InlineStack align="space-between">
              <Text as="h2" variant="headingMd">🗑️ Uninstall Preparation</Text>
              <Badge tone="critical">DANGER ZONE</Badge>
            </InlineStack>
            
            <Banner status="warning">
              <p>Before uninstalling this app, we recommend cleaning up all app data from your store to avoid leaving behind unused metafields.</p>
            </Banner>
            
            <BlockStack gap="300">
              <Text variant="headingMd">What will be removed:</Text>
              <ul style={{ marginLeft: '20px', marginTop: '10px' }}>
                <li>All SEO metafield definitions (seo_ai namespace)</li>
                <li>All AI-generated content (titles, descriptions, bullets, FAQs)</li>
                <li>Store metadata configurations</li>
            ...
            <Banner status="info">
              <p>💡 <strong>Note:</strong> This action will NOT uninstall the app automatically. After cleaning, you'll receive instructions on how to complete the uninstall process in Shopify Admin.</p>
            </Banner>
          </BlockStack>
        </Box>
      </Card>
